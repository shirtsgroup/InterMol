"""This is a *script* to prepare an implicit solvent simulation."""
...
# Default *.mdp settings

defaultMinimizationMdpFile = """
Here's the default mdpfile
....
....
....
"""
...
if __name__ == '__main__':
    ...
    pw = PrepWorker()  # initialize this with the input pdb/gro and output filenames, etc.  
		
    
    # Step 1. Find the shortest box vector
    grostruct = GromacsStructure()
    grostruct.load(pw.files.grofile)
    ...
    # Step 4. Production #### #
    pw.mdrun()   # with PRODUCTION parms

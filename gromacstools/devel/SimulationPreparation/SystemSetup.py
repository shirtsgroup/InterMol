...
class SystemSetup(object):
  ...
  def __init__(self, infile=None): 
    ...
    # forcefield parms
    self.useff='ffamber03'  # string to specify forcefield (default is 'ffamber99p').  'ffamber03' also supported
    self.version='3.1' # gmx version -- supported: '3.1.4' ('3.3.1' COMING SOON - not that diffferent)

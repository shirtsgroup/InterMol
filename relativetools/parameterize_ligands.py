...
#DLM 11/12/10 modified to make importable, including adding a name change and making the block at the end used only if executed as __main__
...
extension = "sdf" # ligand filename extension (could change this to "mol2" if desired)

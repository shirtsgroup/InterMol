...
protein_pdb_filename = "receptor-models/FKBP.pdb" # pdb of the protein without solvent and ligand
...
# Construct minimizer block-MZ
mdpblock['minimizationMZ']= """
; RUN CONTROL PARAMETERS
integrator               = md;
...
""" % vars()
    ...
    mdpfile = MdpFile(compose_blocks(['header', 'minimizationMZ', 'nonbonded-solvent', 'constraints', 'output']))
...
#print commands.getoutput('cp submit-lsf.py %(work_basepath)s' % vars())  #MZ fix

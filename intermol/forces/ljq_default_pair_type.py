...
class LjqDefaultPair(LjqDefaultPairType):
    ...
    stub documentation
    """
    def __init__(self, atom1, atom2, bondingtype1 = None, bondingtype2 = None, scaleLJ = None, scaleQQ = None, long = False):
        self.atom1 = atom1
        self.atom2 = atom2
        LjqDefaultPairType.__init__(self, bondingtype1, bondingtype2, scaleLJ = scaleLJ, scaleQQ = scaleQQ, long = long)

...
#	    sysDirectiveAtm: help locate positions of specific data in m_atoms
      ...
      if re.search("TIP3P", moleculeName) or re.search("WAT", moleculeName):
        moleculeName = "H2O"
	#return
...
#              self.dihedraltypes.add(newDihedralType)
		...
		if templen == 1: #THINK LENGTH IS ORIGINALLY IN ANGSTROMS...NOT SURE
		  ...
		  newConstraint = Constraint9(tempatom[0],tempatom[1],tempatom[2],tempatom[3],tempatom[4],tempatom[5],tempatom[6],tempatom[7],tempatom[8],templength[0],templength[1],templength[2],templength[3],templength[4],templength[5],templength[6],templength[7])
	        ...
	        print "ERROR: Could not recognize constraint"
	      if newConstraint:
	  ...
	  i = 1
	      ...
	      lines.append('      %d %d %d %d %d %s %f %f %f\n'%(i, dihedral.atom1, dihedral.atom2, dihedral.atom3, dihedral.atom4, 'Proper_Harm', float(dihedral.phi._value), float(dihedral.k._value)  * ((0.01745)**(2)) / 4.18, int(dihedral.multiplicity)))
              ...
              if i == 1:
                ...
                lines.append("      r_ffio_c1\n")
                lines.append("      :::\n")
              lines.append('      %d %d %d %d %d %s %f %f\n'%(i, dihedral.atom1, dihedral.atom2, dihedral.atom3, dihedral.atom4, 'Improper_Harm', float(dihedral.phi._value), float(dihedral.k._value) * ((0.01745)**(2)) / 4.18))
	      ...
	      print "ERROR: Cannot find dihedral"
	    i+=1
	  lines.append("      :::\n")
          lines.append("    }\n")
